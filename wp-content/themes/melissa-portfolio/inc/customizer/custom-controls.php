...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class Melissa_Portfolio_Toggle_Switch_Custom_Control extends WP_Customize_Control {
		/**
	 ...
	 */
	class Melissa_Portfolio_Sortable_Repeater_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * Multi Input field
	 */
	class Melissa_Portfolio_Multi_Input_Custom_control extends WP_Customize_Control {
		...
		public function render_content() {
			...
			<label class="customize_multi_input">
				...
				<a href="#" class="button button-primary customize_multi_add_field"><?php echo esc_html__( 'Add More', 'melissa-portfolio' ); ?></a>
			</label>
			<?php
		}
	}
	 ...
	 */
	class Melissa_Portfolio_Customize_Horizontal_Line extends WP_Customize_Control {
		/**
		 * Control Type
		 */
		public $type = 'hr';
     ...
     * Repeater Field
     */
    class Melissa_Portfolio_Customize_Field_Repeater extends WP_Customize_Control {
        public $id;
        ...
        public function __construct( $manager, $id, $args = array() ) {
            ...
            $this->add_field_label = esc_html__( 'Add new field', 'melissa-portfolio' );
            if ( ! empty( $args['add_field_label'] ) ) {
                $this->add_field_label = $args['add_field_label'];
            }

            $this->boxtitle = esc_html__( 'Customizer Repeater', 'melissa-portfolio' );
        ...
        public function enqueue() {
            wp_enqueue_style( 'font-awesome', get_template_directory_uri().'/assets/css/font-awesome.css', array(), MELISSA_PORTFOLIO_VERSION );
            wp_enqueue_style( 'melissa-portfolio-customizer-repeater-admin-stylesheet', get_template_directory_uri().'/assets/css/admin-style.css', array(), MELISSA_PORTFOLIO_VERSION );
            wp_enqueue_style( 'wp-color-picker' );
            wp_enqueue_script( 'melissa-portfolio-customizer-customizer-repeater-script', get_template_directory_uri() . '/assets/js/customizer_repeater.js', array('jquery', 'jquery-ui-draggable', 'wp-color-picker' ), MELISSA_PORTFOLIO_VERSION, true  );
            wp_enqueue_script( 'melissa-portfolio-customizer-repeater-fontawesome-iconpicker', get_template_directory_uri() . '/assets/js/fontawesome-iconpicker.js', array( 'jquery' ), MELISSA_PORTFOLIO_VERSION, true );
            wp_enqueue_style( 'melissa-portfolio-customizer-repeater-fontawesome-iconpicker-script', get_template_directory_uri() . '/assets/css/fontawesome-iconpicker.min.css', array(), MELISSA_PORTFOLIO_VERSION );
        }
                        ...
                        <div class="customizer-repeater-box-content-hidden">
                            ...
                            if($this->custom_repeater_color_control == true){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Color','melissa-portfolio' ), $this->id, 'custom_repeater_color_control' ),
                            ...
                            if($this->custom_repeater_color2_control == true){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Color','melissa-portfolio' ), $this->id, 'custom_repeater_color2_control' ),
                            ...
                            if($this->custom_repeater_title_control==true){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Title','melissa-portfolio' ), $this->id, 'custom_repeater_title_control' ),
                            ...
                            if($this->custom_repeater_subtitle_control==true){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Subtitle','melissa-portfolio' ), $this->id, 'custom_repeater_subtitle_control' ),
                            ...
                            if($this->custom_repeater_text_control==true){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Text','melissa-portfolio' ), $this->id, 'custom_repeater_text_control' ),
                            ...
                            if($this->custom_repeater_link_control){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Link','melissa-portfolio' ), $this->id, 'custom_repeater_link_control' ),
                            ...
                            if($this->custom_repeater_text2_control==true){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Text','melissa-portfolio' ), $this->id, 'custom_repeater_text2_control' ),
                            ...
                            if($this->custom_repeater_link2_control){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Link','melissa-portfolio' ), $this->id, 'custom_repeater_link2_control' ),
                            ...
                            if($this->custom_repeater_shortcode_control==true){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Shortcode','melissa-portfolio' ), $this->id, 'custom_repeater_shortcode_control' ),
                            ...
                            <button type="button" class="social-repeater-general-control-remove-field" <?php if ( $it == 0 ) {
                                ...
                                <?php echo esc_html__( 'Delete field', 'melissa-portfolio' ); ?>
                            </button>
            ...
            if( !empty($options['type']) ){
                switch ($options['type']) {
                    case 'textarea':?>
                        ...
                        <textarea name="<?php echo esc_attr( $options['name'] ); ?>" class="<?php echo esc_attr( $options['class'] ); ?>" placeholder="<?php echo esc_attr( $options['label'] ); ?>"><?php echo ( !empty($options['sanitize_callback']) ?  call_user_func_array( $options['sanitize_callback'], array( $value ) ) : esc_attr($value) ); ?></textarea>
                        <?php
                        break;
                    case 'color':
                        $style_to_add = '';
        ...
        private function icon_picker_control($value = '', $show = ''){
            ...
            <span class="customize-control-title">
                <?php echo esc_html__('Icon','melissa-portfolio'); ?>
            </span>
                <span class="description customize-control-description">
                <?php printf( __( 'Note: Some icons may not be displayed here. You can see the full list of icons at %s', 'melissa-portfolio' ), 'http://fontawesome.io/icons/' ); ?>
            </span>
        ...
        private function image_control($value = '', $show = '', $attrs = array()){ ?>
            ...
            <span class="customize-control-title">
                <?php printf(__('%s', 'melissa-portfolio'), $attrs['label']); ?>
            </span>
                <input type="text" name="<?php echo esc_attr($attrs['name']) ?>" class="widefat custom-media-url <?php printf(__('%s', 'melissa-portfolio'), $attrs['class']); ?>" value="<?php printf(__('%s', 'melissa-portfolio'), esc_attr( $value )); ?>">
                <input type="button" class="button button-secondary customizer-repeater-custom-media-button" value="<?php printf(__('Upload Image', 'melissa-portfolio'), $attrs['class']); ?>" />
            </div>
            <?php
        }

        private function icon_type_choice($value='customizer_repeater_icon'){ ?>
            <span class="customize-control-title"><?php esc_html__('Image type','melissa-portfolio');?></span>
            <select class="customizer-repeater-image-choice">
                <option value="customizer_repeater_icon" <?php selected($value,'customizer_repeater_icon');?>><?php esc_html__('Icon','melissa-portfolio'); ?></option>
                <option value="customizer_repeater_image" <?php selected($value,'customizer_repeater_image');?>><?php esc_html__('Image','melissa-portfolio'); ?></option>
                <option value="customizer_repeater_none" <?php selected($value,'customizer_repeater_none');?>><?php esc_html__('None','melissa-portfolio'); ?></option>
            </select>
            <?php
        }
        ...
        private function icon_type_radio($value, $field){ ?>
            <span class="customize-control-title">
                <?php printf( __( '%s', 'melissa-portfolio' ), $field['label']);?>
            </span>
        ...
        private function repeater_control($value = ''){
            ...
            $show_del        = 0; ?>
            <span class="customize-control-title"><?php echo esc_html__( 'Social icons', 'melissa-portfolio' ); ?></span>
            <?php
            '<span class="description customize-control-description">';
                printf(__('Note: Some icons may not be displayed here. You can see the full list of icons at %s', 'melissa-portfolio'), 'http://fontawesome.io/icons/');
            echo '</span>';
            if(!empty($value)) {
            ...
            if ( ( count( $social_repeater ) == 1 && '' === $social_repeater[0] ) || empty( $social_repeater ) ) { ?>
                <div class="customizer-repeater-social-repeater">
                    <div class="customizer-repeater-social-repeater-container">
                        ...
                        <?php get_template_part( $this->custom_icon_container ); ?>
                        <input type="text" class="customizer-repeater-social-repeater-link" placeholder="<?php esc_attr_e( 'Link', 'melissa-portfolio' ); ?>">
                        <input type="hidden" class="customizer-repeater-social-repeater-id" value="">
                        <button class="social-repeater-remove-social-item" style="display:none">
                            <?php esc_html__( 'Remove Icon', 'melissa-portfolio' ); ?>
                        </button>
                    </div>
                    <input type="hidden" id="social-repeater-socials-repeater-colector" class="social-repeater-socials-repeater-colector" value=""/>
                </div>
                <button class="social-repeater-add-social-item button-secondary"><?php esc_html__( 'Add Icon', 'melissa-portfolio' ); ?></button>
                <?php
            } else { ?>
                <div class="customizer-repeater-social-repeater">
                    <?php
                    foreach ( $social_repeater as $social_icon ) {
                        ...
                        <div class="customizer-repeater-social-repeater-container">
                            ...
                            <input type="text" class="customizer-repeater-social-repeater-link"
                                   placeholder="<?php esc_attr_e( 'Link', 'melissa-portfolio' ); ?>"
                            ...
                            <button class="button-primary social-repeater-remove-social-item" style="<?php if ( $show_del == 1 ) {echo "display:none";} ?>"><?php esc_html__( 'Remove Icon', 'melissa-portfolio' ); ?></button>
                        </div>
                        <?php
                    } ?>
        ...
        private function repeater_fields($value = '', $data = array()) {
            ...
            ?>
            <span class="customize-control-title"><?php printf(__('%s', 'melissa-portfolio'), $data['label'][0]); ?></span>
            <div class="customizer-repeater-field" data-key="<?php printf(__('%s', 'melissa-portfolio'), $data['key']); ?>">
                ...
                <div class="customizer-repeater-field__group">
                            ...
                            <div class="customizer-repeater-field__item">
                                <?php
                                    if($item['type'] == 'textarea') {
                                        $this->input_control( array(
                                            'label' => apply_filters('repeater_input_labels_filter', sprintf(__('%s', 'melissa-portfolio'), $item['label']), $this->id, 'custom_repeater_link_control' ),
                                            'class' => $item['class'],
                                            'name'  => $name,
                                            'type' => $item['type'],
                    ...
                    ?>
                    <?php
                        $item_delete = esc_attr( 'Remove Item', 'melissa-portfolio' );
                ...
                <?php
                $item_add = esc_attr( 'Add Item', 'melissa-portfolio' );
     ...
     * Select Multiple
     */
    class Melissa_Portfolio_Customize_Select_Multiple extends WP_Customize_Control {
        /**
...
if ( class_exists( 'WP_Customize_Section' ) ) {
	 ...
	 * Upsell section
	 */
	class Melissa_Portfolio_Custom_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'melissa-portfolio-upsell';
		...
		protected function render() {
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="melissa_portfolio_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
