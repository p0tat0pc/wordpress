...
(function($, api) {
   ...
   api.sectionConstructor['melissa-portfolio-upsell'] = api.Section.extend({
   ...
   const melissa_portfolio_section_lists = ['banner','skill','experience','gallery','blog','cta'];
   melissa_portfolio_section_lists.forEach(melissa_portfolio_homepage_scroll);

   function melissa_portfolio_homepage_scroll(item, index) {
        // Detect when the front page sections section is expanded (or closed) so we can adjust the preview accordingly.
        item = item.replace(/-/g, '_');
        wp.customize.section('melissa_portfolio_' + item + '_section', function(section) {
