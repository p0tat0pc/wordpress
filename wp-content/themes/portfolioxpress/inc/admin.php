...
function portfolioxpress_admin_setup()
{

    /**
     * Load and initialize PortfolioXpress Dashboard Notices
     *
     */
...
add_action('after_setup_theme', 'portfolioxpress_admin_setup');
