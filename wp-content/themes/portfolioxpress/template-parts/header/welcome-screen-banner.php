 ...
 */
$ed_header_type = portfolioxpress_get_option( 'ed_header_type' );
$upload_add_image = portfolioxpress_get_option( 'upload_add_image' );
$ed_header_link = portfolioxpress_get_option( 'ed_header_link' );
$advertisement_section_title = portfolioxpress_get_option( 'advertisement_section_title' );
?>
            ...
            <header class="welcome-screen-header">
                ...
                <div class="welcome-screen-actions">
                    ...
                    <button type="button" class="welcome-screen-skip">
                        <?php echo esc_html__('Skip This', 'portfolioxpress') ?>
                    </button>
                </div>
            </header>
        <?php } ?>
